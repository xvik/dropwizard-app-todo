...
public class StaticResourceTest extends AbstractTest {
    ...
    void testRest() {
        ...
        WHEN("Loading by ID");
        Todo item = rest.method(instance -> instance.getById(1)).as(Todo.class);
        ...
        Todo patch = Todo.builder()
                ...
                .completed(true)
                .build();
        Todo updated = rest.method(instance -> instance.edit(1, patch)).as(Todo.class);
        ...
        WHEN("Remove record");
        rest.method(instance -> instance.deleteById(1)).asVoid();
        res = rest.method(instance -> instance.get()).as(new GenericType<>() {});
